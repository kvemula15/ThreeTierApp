...
import com.spansystems.springmvc.service.EmployeeService;
...
public class AppController {
	...
	public String editEmployee(ModelMap model, @PathVariable String ssn) {
		List<Employee> employeeList = service.findEmployeeBySsn(ssn);
		Employee employee = new Employee();
